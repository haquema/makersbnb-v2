TRUNCATE TABLE users, properties, bookings RESET IDENTITY;
...
INSERT INTO properties (name, description, price, to_rent, user_id) VALUES ('Modern City Apartment', 'you''ll be sure to have an out of this world experience in our UFO-styled treehouse', 500, true, 1);
...
INSERT INTO bookings (property_id, user_id, start_date, end_date, status) VALUES (1, 2, '2023-05-25', '2023-05-29', 'confirmed');